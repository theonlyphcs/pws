...
while True:
    ...
    try:
        ...
        sql= "INSERT INTO SENSORREADINGS(time, tempC, tempF, press, humid, wspeed,rainfall) VALUES ('%s','%d','%d','%d','%d','%d','%d)" % (readingtime, sense_data[0], sense_data[1], sense_data[2], sense_data[3], wspeed, rff)
        try:
